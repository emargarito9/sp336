...
public class ProductController
{
    ...
    @ApiOperation(value = "Get all products form the database.")
    @RequestMapping(method = RequestMethod.GET, value = "/products/getAll")
    public Iterable<Product> GetAll(){
            return productService.GetAll();
        }
    @ApiOperation(value = "Add a new product ot the database.")
    @RequestMapping(method = RequestMethod.POST, value = "/products/add")
    public void AddProduct(@RequestBody Product merchandise){
        productService.AddProduct(merchandise);
    }
